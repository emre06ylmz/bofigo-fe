...
import OptionItemsPostForm from "./OptionItemsPostForm/OptionItemsPostForm";
import OptionItemsUpdateForm from "./OptionItemsUpdateForm/OptionItemsUpdateForm";
    ...
    <React.Fragment>
      ...
      {modalInfo.type === "POST" && (
        <Modal
          ...
          footer={null}
        >
          <OptionItemsPostForm handleClose={hideModal} parentId={parentId} />
        </Modal>
      )}
